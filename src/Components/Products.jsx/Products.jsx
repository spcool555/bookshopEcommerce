...
const url = `https://Navneet Law Studios-data-h5tg.onrender.com`
...
const Products = () => {
    ...
    const fetchData = () => {
        ...
        // fetch(`${apiUrl}/all?${homepagecategory_nameurl}&_limit=${perPagelimitProduct}&_page=${page}${pricesorturl}${priceRangeurl}${tempUrl}`)
        fetch(`${apiUrl}/all?${homepagecategory_nameurl}&_limit=${perPagelimitProduct}&_page=${page}${pricesorturl}${priceRangeurl}${tempUrl}`)
            .then((res) => {
    ...
    const getScrollProducts = async() => {
        try {
          const res = await fetch(`${apiUrl}/all?_limit=8&_page=${page}`);
