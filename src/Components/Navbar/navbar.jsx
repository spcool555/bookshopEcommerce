...
const Navbar = () => {
  ...
  const fetchData = (searchVal) => {
    fetch(`${apiUrl}?_limit=5&q=${searchVal}`)    //  this code is for  filter  make filter api for this
      .then((res) => res.json())
      .then((res) => {
        // setData(res)
        setData(res)
  ...
  const handleLogout = () => {
    ...
    localStorage.setItem("uid", ''); // Save uid to localStorage
              ...
              >
                {
                  data.map((item, index) => (
                    <Box key={index}>
                      <NavLink to={`/products/view/${item.id}`}>
            ...
            <Popover trigger="hover" >
              ...
              >
                ...
                <PopoverBody color="black" className='shade' >
                  ...
                  <hr />
                  {/* <Flex cursor={'pointer'} className="pop1" h='49px' fontSize='14px'><Center ml='10px'><Image src={vikas} alt="dfd" /></Center> <Center ml='16px'>Navneet Law Studios</Center></Flex> */}
                  <hr />
                  {/* orderpage */}
            ...
            <Flex bg="#2874f0" h='52px' >
              ...
              >
                ...
                <DrawerContent
                  ...
                  <DrawerHeader bg='#2874f0' color='white' h='40px' className="head"> <Center ><FaUser pr='10px' fontSize='15px' /> &nbsp; <Login /> </Center> <Center><Image src="logo.webp" w='20px' h='20px' /></Center></DrawerHeader>
                  ...
                  <DrawerBody ml='-5px' onClick={onClose}>
                    ...
                    {/* <Flex h="38px" fontSize='14px'   > <Center ><Image src={icon3} w="15px" /></Center> <Center className="drawer" ml='16px'>Navneet Law Studios</Center></Flex><hr /> */}
                    ...
                    <Flex h="38px" fontSize='14px' > <Center ><Image src={icon5} w='15px' /></Center> <Center className="drawer" ml='16px'>More on Navneet Law Studios</Center></Flex><hr />
                    ...
                    {/* <Flex h="38px" fontSize='14px'>  <Center ><Image src={icon8} w='15px' /></Center><Center className="drawer" ml='16px'>Sell on Navneet Law Studios</Center></Flex> */}
